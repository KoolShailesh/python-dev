...
def configure_otel(service_name: str, app=None):
    ...
    # Console handler for stdout (so you see logs locally too)
    ...
    root_logger.addHandler(console_handler)     # Local log with trace info
    root_logger.addHandler(otel_handler)        # OTLP log to CloudWatch via Collector
